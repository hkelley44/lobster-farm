...
- `router.ts` -- Discord message router. Deterministic rules: command prefix (`!lf`) parsing, channel-type routing (alerts, work rooms, general), keyword-based intent classification.
