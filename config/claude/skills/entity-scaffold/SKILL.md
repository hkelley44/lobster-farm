...
The endpoint returns the category ID and channel IDs. Update the entity config with these. The daemon automatically pins a "🟢 Available" status message in each work room during scaffolding.
